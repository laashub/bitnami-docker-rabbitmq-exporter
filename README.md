...
* [`0-debian-9`, `0.29.0-debian-9-r4`, `0`, `0.29.0`, `0.29.0-r4`, `latest` (0/debian-9/Dockerfile)](https://github.com/bitnami/bitnami-docker-rabbitmq-exporter/blob/0.29.0-debian-9-r4/0/debian-9/Dockerfile)
...
```bash
$ docker build -t bitnami/rabbitmq-exporter:latest https://github.com/bitnami/bitnami-docker-rabbitmq-exporter.git
```
