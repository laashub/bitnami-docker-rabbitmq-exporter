...
* [`0-debian-10`, `0.29.0-debian-10-r64`, `0`, `0.29.0`, `latest` (0/debian-10/Dockerfile)](https://github.com/bitnami/bitnami-docker-rabbitmq-exporter/blob/0.29.0-debian-10-r64/0/debian-10/Dockerfile)
...
```bash
$ docker build -t bitnami/rabbitmq-exporter:latest 'https://github.com/bitnami/bitnami-docker-rabbitmq-exporter.git#master:0/debian-10'
```
...
### Step 2: Launch the rabbitmq-exporter container within your network
...
If you encountered a problem running this container, you can file an [issue](https://github.com/bitnami/bitnami-docker-rabbitmq-exporter/issues/new). For us to provide better support, be sure to include the following information in your issue:
